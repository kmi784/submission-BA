...
/**** Number of threads *******/ const unsigned int Nthread = 3;
...
class System{
    ...
    public:
        System(char='U', unsigned int=1);   // Constructor of the system 1: 'F'=ferromagnetic,      'H'=horizonatal-stripped, 
                                            ...
                                            //                           2: PRNG-engine seed
        System(const System&);              // Copy-constructor necessary for array initialization
        ~System();                          // Destructur of the system
        System& operator=(const System&);   // Copy-assignment operator necessary for array initialization
